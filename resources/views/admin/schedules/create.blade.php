@extends('layouts.app', ['title' => 'Add Time Schedule - Super Admin'])
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-900 flex items-center gap-2">
                ...
                <span>Add Time Schedule</span>
            </h1>
            <p class="text-xs text-slate-500 mt-0.5">Assign departure time slot, route, service class, and optional bus vehicle.</p>
        </div>
        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="time" name="departure_time" id="departure_time" value="{{ old('departure_time', '08:00') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="duration_minutes" id="duration_minutes" value="{{ old('duration_minutes', 300) }}" placeholder="e.g. 300 (5 hrs)"
                        class="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-[#da1705] text-sm text-slate-800">
                    <p class="text-[10px] text-slate-400 mt-1">Auto calculates arrival time if left blank.</p>
