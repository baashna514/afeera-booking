@extends('layouts.app', ['title' => 'Add Ticket Fare - Super Admin'])
...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-900 flex items-center gap-2">
                ...
                <span>Add Ticket Fare</span>
            </h1>
            <p class="text-xs text-slate-500 mt-0.5">Define fare price between any two cities on a route.</p>
        </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8">
        <form action="{{ route('admin.fares.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="10" name="fare_amount" id="fare_amount" value="{{ old('fare_amount') }}" placeholder="1500" required
            ...
            <div class="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2.5 bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold rounded-xl shadow-lg shadow-rose-600/30 transition flex items-center gap-2">
                    <i class="fa-solid fa-check"></i> Save Fare
                </button>
            </div>
        </form>
    </div>
